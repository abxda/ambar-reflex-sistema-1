...
Valores esperados con el diseño vigente (rediseño arcade + flujo JSON + etiqueta del modelo) si el
código de render **no** cambió (mismo ffmpeg/libx264):

| Archivo | MD5 (12 primeros caracteres) | Vídeo | Duración |
|---|---|---|---|
| sistema1_1080p60.mp4 | `cc5160522526` | h264 1920×1080 60/1 + aac | 27.116667 |
| sistema1_momentos_clave.mp4 | `66da58965530` | h264 1920×1080 60/1 + aac | 35.116667 |
| sistema1_vertical_1080x1920.mp4 | `3bb50bea405d` | h264 1080×1920 60/1 + aac | 27.116667 |
